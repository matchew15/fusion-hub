...
export default function ListingForm({ onSuccess }: ListingFormProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="h-[100dvh] flex flex-col">
        {/* Fixed header */}
        ...
        {/* Fixed footer */}
        <div className="flex-shrink-0 p-4 border-t border-border/10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
